 ...
 * rather than in a settings pane. One entry per boundary the host's `toolchain-box/projects`
 * actually names, plus `host` for everything that runs outside a box -- which is the one that
 * wants noticing, hence red.
 *
